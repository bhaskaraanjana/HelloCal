...
4. [x] gemini.ts: add fetchSupplementInfo, fetchMicronutrientInfo, parseRecipeDescription.
...
8. [x] Dashboard: render customMicros[]; port drag-drop/collapse onto OURS clean Dashboard
